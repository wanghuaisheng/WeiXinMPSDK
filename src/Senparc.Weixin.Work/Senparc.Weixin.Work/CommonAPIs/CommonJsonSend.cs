...
namespace Senparc.Weixin.Work.CommonAPIs
{
    ...
    public static class CommonJsonSend
    {
        ...
        /// <returns></returns>
        public static WorkJsonResult Send(string accessToken, string urlFormat, object data, CommonJsonSendType sendType = CommonJsonSendType.POST, int timeOut = Config.TimeOut, bool checkValidationResult = false, JsonSetting jsonSetting = null)
        {
