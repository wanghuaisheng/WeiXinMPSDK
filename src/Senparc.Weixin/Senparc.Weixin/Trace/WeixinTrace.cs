...
namespace Senparc.Weixin
{
    ...
    public static class WeixinTrace
    {
        ...
        /// 统一日志锁名称
        /// </summary>
        private const string LockName = "WeixinTraceLock";

        /// <summary>
        /// Senparc.Weixin全局统一的缓存策略
        /// </summary>
        private static IObjectCacheStrategy Cache => CacheStrategyFactory.GetObjectCacheStrategyInstance();
        ...
        internal static void Open()
        {
            ...
            {
                var logDir = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "App_Data", "WeixinTraceLog");
        ...
        internal static void Close()
        {
            using (Cache.BeginCacheLock(LockName, ""))
            {
                if (_traceListener == null || !Trace.Listeners.Contains(_traceListener)) return;
